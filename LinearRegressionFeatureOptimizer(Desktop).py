...
"""for Data in Dataframe:
    print("Data:", Data)
    EmptyDataList.append(Data) #adds in each data feature one at a time
    NewDataList = EmptyDataList


print("Empty Data List:",EmptyDataList)
DataPicks = str(EmptyDataList)
print("Data picks:", DataPicks)"""
TargetVariable = "G3"


X = np.array(DataPicks.drop(["G3"], axis=1)) #this gets rid of the array of all G3 data and keeps it from being used to as a feature/attribute
y = np.array(DataPicks["G3"]) #this creates an array in your output that is for G3
