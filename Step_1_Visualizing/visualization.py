...
class Grapher:
    def data_type_cleaner(self, original_df, target_variable):
    ...
    def main_visualizer(self, type_clean_df, target_variable):
        ...
        try:
            ...
            # Widgets
            graph_selection_combo_box = ttk.Combobox(graphing_window, values=('Target Correlation', 'Target Distribution', 'All Data Distribution', 'Unique Values'))
